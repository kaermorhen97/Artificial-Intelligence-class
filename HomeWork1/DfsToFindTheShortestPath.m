function [shortestPath] = DfsToFindTheShortestPath(importedCoordinateData, ...
    tableForConnectedVertices, commonData, dfsSpecificData, shortestPath, currentPath)
    ...
    for index = 1:length(nextPossibleVertices)
        ...
        distance = DistanceCalculator(importedCoordinateData, currentVertex, nextVertexToVisit);
        ...
        if(dfsSpecificData.visitedList(nextVertexToVisit) == 0)
            ...
            [shortestPath] = DfsToFindTheShortestPath(importedCoordinateData, ...
                tableForConnectedVertices, commonData, dfsSpecificData, shortestPath, currentPathForRecursion);
        end
    end
