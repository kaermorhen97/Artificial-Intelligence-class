function [shortestPath] = GreedyToFindTheShortestPath(importedCoordinateData, tableForConnectedVertices, commonData)
% GreedyToFindTheShortestPath Greedy best-first Search
...
importedCoordinateData(targetVertex,1))^2)+((importedCoordinateData(nextVertexToVisit,2)-
