function DisplayTheShortestPath(coordinatesOfVertices, inputPath, distance, startPoint)
  ...
  plot(coordinatesOfVertices(inputPath(numberOfPlots,:),1),coordinatesOfVertices(inputPath(nu
  mberOfPlots,:),2), 'b', 'LineWidth', 4)
  ...
  text(coordinatesOfVertices(numberOfVertices,1),coordinatesOfVertices(numberOfVertices,2), 
  vertexName);
  end
